...
csv1 = pd.read_csv('/simple/a1.csv', nrows=3)
# print(csv1)

csv1 = pd.read_csv('/simple/a1.csv', header=0)
# print(csv1)

csv1 = pd.read_csv('/simple/a1.csv', index_col=0)
# print(csv1)

csv1 = pd.read_csv('/simple/a1.csv', skiprows=1)
# print(csv1)

csv1 = pd.read_csv('/simple/a1.csv', prefix="$", header=None)
# print(csv1)

csv1 = pd.read_csv('/simple/a1.csv')
# print(csv1.head(2))
